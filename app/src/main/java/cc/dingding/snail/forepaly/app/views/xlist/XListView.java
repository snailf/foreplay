 ...
 */
package cc.dingding.snail.forepaly.app.views.xlist;
...
public class XListView extends ListView implements OnScrollListener {
    ...
    private void initWithContext(Context context) {
        ...
        sharedPreferences = MainApplication.getInstance().getSharedPreferences("config", 0);
    ...
    private void updateRefreshTime() {
        String str = null;
        if (!hasStart) {
            lastRefreshTime = sharedPreferences.getLong(KEY_REFRESH_TIME, 0);
            hasStart = true;
        }
    ...
    private void saveRefreshTime() {
        if (hasStart == true) {
            editor.putLong(KEY_REFRESH_TIME, System.currentTimeMillis());
            editor.commit();
            hasStart = false;
        }
