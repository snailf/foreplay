...
//                LogUtil.e("postion", preY + ":" + nowY + "=" + deltaY + (mIsCount ? "true" : "false"));
                if (!mIsCount) {
                    deltaY = 0; // 在这里要归0.
                }
                y = nowY;
...
//                    LogUtil.e("changed", mInnerView.getTop() + ":" + mInnerView.getBottom() );
                }
                mIsCount = true;
                break;
            default:
    ...
    public void animation() {
        // 开启移动动画
//        LogUtil.e("animation", mInnerView.getTop() + ":" + mNormal.top);
...
//        LogUtil.e("isneed", offset + ":" + scrollY);
        // 0是顶部，后面那个是底部
